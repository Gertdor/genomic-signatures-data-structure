...
parser.add_argument("--greedy_start",type=float,default=0,help="start value of greedy_factor when running greedy__test")
parser.add_argument("--greedy_end",type=float,default=4,help="end value of greedy_factor when running greedy_test")
parser.add_argument("--greedy_num_samples",type=int,default=20,help="number of samples to take between greedy_start and greedy_end when running greedy_test")
